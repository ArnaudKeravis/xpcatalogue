...
/**
 * **E&R** — Energy & Resources benchmark innovations (Canada, India, Chile, Brazil, UK & Ireland).
...
export const COLLECTION_META: Record<SolutionCollection, CollectionMeta> = {
  ...
  er: {
    ...
    description:
      'Field-tested innovations from Sodexo Energy & Resources teams across Canada, India, Chile, Brazil and the UK & Ireland — remote camps, offshore living, mining automation, defence dining and frictionless retail.',
