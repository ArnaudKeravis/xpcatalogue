        ...
        <div className="mx-auto grid max-w-[1600px] gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-center lg:gap-12">
          <div className="flex flex-col items-start gap-5 text-white">
            ...
            >
              ...
              <span className="relative inline-block not-italic text-[var(--teal)]">
                change?
                <span
                  aria-hidden
            ...
            >
              {erSegment ? (
                <>
                  ...
                  <strong className="text-white">E&amp;R personae</strong>, the{' '}
                  <strong className="text-white">user-needs hub</strong>, or jump into{' '}
                  <strong className="text-white">solutions</strong> — then open the home-to-home journey for
                  the shift rhythm.
                </>
              ) : (
                <>
                  ...
                  <strong className="text-white">place</strong>, a <strong className="text-white">person</strong>,
                  or a <strong className="text-white">moment</strong>.
                </>
              )}
            </p>
          </div>
        ...
        <div className="mx-auto grid max-w-[1600px] gap-6 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
          ...
          {erSegment && workArea && spotlightBoK ? (
            <FeaturedPersona
              ...
              role={spotlightBoK.role}
              quote={spotlightBoK.quote}
              areaLabel="Energy & Resources"
              areaColor={workArea.color}
              color="#2d6a8f"
              href={spotlightHref}
            />
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex items-center justify-between text-[11px]">
        <span className="font-semibold uppercase tracking-[0.14em] text-white/70">{hint ?? footer}</span>
...
function PersonaAvatar({ photo, color, name }: { photo?: string; color: string; name: string }) {
  if (photo) {
    return (
      <>
  ...
  return (
    <span className="flex h-full w-full items-center justify-center" style={{ background: color }} aria-hidden>
